...
1. Выберите вариант - Файл с настройками подключения ![конфигурация](/media/awg-configure.png), если у вас есть .conf файл, либо, вставьте строку-конфиг (например, если получали ключ в боте amnezia) ![конфигурация](/media/awg-insert-key.png)
